...
abstract class RustLibApi extends BaseApi {
  ...
  Future<RootsResponse> crateApiHttpRsHttpClientListRoots({
    required RsHttpClient that,
    required ProtocolType protocol,
    required String ip,
    required int port,
  ...
  RsHttpClient crateApiHttpCreateHttpOnlyClient();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<RsFsDownloadEvent> crateApiHttpRsHttpClientFsDownload({
    ...
    final sink = RustStreamSink<RsFsDownloadEvent>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            final serializer = SseSerializer(generalizedFrbRustBinding);
            sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRsHttpClient(that, serializer);
            sse_encode_StreamSink_rs_fs_download_event_Sse(sink, serializer);
            sse_encode_protocol_type(protocol, serializer);
            sse_encode_String(ip, serializer);
            sse_encode_u_16(port, serializer);
          ...
          constMeta: kCrateApiHttpRsHttpClientFsDownloadConstMeta,
          argValues: [that, sink, protocol, ip, port, path, rangeStart, rangeEnd, cancelToken],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiHttpRsHttpClientFsDownloadConstMeta => const TaskConstMeta(
    debugName: 'RsHttpClient_fs_download',
    argNames: ['that', 'sink', 'protocol', 'ip', 'port', 'path', 'rangeStart', 'rangeEnd', 'cancelToken'],
  );
  ...
  Future<ListResponse> crateApiHttpRsHttpClientListDir({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiHttpRsHttpClientListDirConstMeta,
        argValues: [that, protocol, ip, port, path, page, size, sort],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiHttpRsHttpClientListDirConstMeta => const TaskConstMeta(
    debugName: 'RsHttpClient_list_dir',
    argNames: ['that', 'protocol', 'ip', 'port', 'path', 'page', 'size', 'sort'],
  );
  ...
  Future<RootsResponse> crateApiHttpRsHttpClientListRoots({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiHttpRsHttpClientListRootsConstMeta,
  ...
  TaskConstMeta get kCrateApiHttpRsHttpClientListRootsConstMeta => const TaskConstMeta(
    debugName: 'RsHttpClient_list_roots',
  ...
  RsHttpClient crateApiHttpCreateHttpOnlyClient() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiHttpCreateHttpOnlyClientConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiHttpCreateHttpOnlyClientConstMeta => const TaskConstMeta(
    debugName: 'create_http_only_client',
    argNames: [],
  );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_Set_capability_None(capabilities, serializer);
  ...
  Future<RsHttpServer> crateApiServerStartServer({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [port, tls, alias, version, deviceModel, deviceType, fingerprint, capabilities, pin, verifyChecksums, web, showToken],
        apiImpl: this,
      ),
    );
  }
  ...
  @protected
  Set<Capability> dco_decode_Set_capability_None(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Set.from(dco_decode_list_capability(raw));
  }
  ...
  @protected
  FsRoot dco_decode_fs_root(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    ...
    return FsRoot(
      ...
      freeBytes: dco_decode_u_64(arr[4]),
  ...
  @protected
  List<FsRoot> dco_decode_list_fs_root(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_fs_root).toList();
  }
  ...
  ListResponse dco_decode_list_response(dynamic raw) {
    ...
    return ListResponse(
      entries: dco_decode_list_fs_entry(arr[0]),
  ...
  RegisterDtoV2 dco_decode_register_dto_v_2(dynamic raw) {
    ...
    return RegisterDtoV2(
      ...
      capabilities: dco_decode_list_capability(arr[8]),
    );
  }
  ...
  @protected
  RootsResponse dco_decode_roots_response(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return RootsResponse(
      roots: dco_decode_list_fs_root(arr[0]),
    );
  }
  ...
  RsDiscoveredDevice dco_decode_rs_discovered_device(dynamic raw) {
    ...
    return RsDiscoveredDevice(
      ...
      capabilities: dco_decode_Set_capability_None(arr[9]),
    );
  }
  ...
  RsFsDownloadEvent dco_decode_rs_fs_download_event(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return RsFsDownloadEvent_Started(
          totalSize: dco_decode_u_64(raw[1]),
          status: dco_decode_u_16(raw[2]),
        );
      case 1:
        return RsFsDownloadEvent_Chunk(
          bytes: dco_decode_list_prim_u_8_strict(raw[1]),
          transferred: dco_decode_u_64(raw[2]),
        );
      case 2:
        return RsFsDownloadEvent_Finished();
      case 3:
        return RsFsDownloadEvent_Cancelled();
      case 4:
        return RsFsDownloadEvent_Failed(
  ...
  RsStoredDevice dco_decode_rs_stored_device(dynamic raw) {
    ...
    return RsStoredDevice(
      ...
      capabilities: dco_decode_Set_capability_None(arr[6]),
      channels: dco_decode_list_rs_device_channel(arr[7]),
    );
  }
  ...
  @protected
  Set<Capability> sse_decode_Set_capability_None(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_list_capability(deserializer);
    return Set.from(inner);
  }
  ...
  FsEntry sse_decode_fs_entry(SseDeserializer deserializer) {
    ...
    return FsEntry(name: var_name, isDir: var_isDir, size: var_size, mtime: var_mtime, mime: var_mime);
  }

  @protected
  FsRoot sse_decode_fs_root(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_id = sse_decode_String(deserializer);
  ...
  @protected
  List<FsRoot> sse_decode_list_fs_root(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <FsRoot>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_fs_root(deserializer));
    }
    return ans_;
  }
  ...
  ListResponse sse_decode_list_response(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_entries = sse_decode_list_fs_entry(deserializer);
    var var_total = sse_decode_usize(deserializer);
    var var_hasMore = sse_decode_bool(deserializer);
    return ListResponse(entries: var_entries, total: var_total, hasMore: var_hasMore);
  }
  ...
  RegisterDtoV2 sse_decode_register_dto_v_2(SseDeserializer deserializer) {
    ...
    var var_capabilities = sse_decode_list_capability(deserializer);
    return RegisterDtoV2(
      alias: var_alias,
      version: var_version,
      deviceModel: var_deviceModel,
  ...
  @protected
  RootsResponse sse_decode_roots_response(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_roots = sse_decode_list_fs_root(deserializer);
    return RootsResponse(roots: var_roots);
  }
  ...
  RsDiscoveredDevice sse_decode_rs_discovered_device(SseDeserializer deserializer) {
    ...
    var var_protocol = sse_decode_protocol_type(deserializer);
    var var_download = sse_decode_bool(deserializer);
    var var_capabilities = sse_decode_Set_capability_None(deserializer);
    return RsDiscoveredDevice(
      alias: var_alias,
      version: var_version,
      deviceModel: var_deviceModel,
  ...
  RsFsDownloadEvent sse_decode_rs_fs_download_event(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        return RsFsDownloadEvent_Started(totalSize: var_totalSize, status: var_status);
      case 1:
        var var_bytes = sse_decode_list_prim_u_8_strict(deserializer);
        var var_transferred = sse_decode_u_64(deserializer);
        return RsFsDownloadEvent_Chunk(bytes: var_bytes, transferred: var_transferred);
      case 2:
        return RsFsDownloadEvent_Finished();
      case 3:
        return RsFsDownloadEvent_Cancelled();
      case 4:
        ...
        return RsFsDownloadEvent_Failed(error: var_error);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  @protected
  void sse_encode_Set_capability_None(Set<Capability> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_capability(self.toList(), serializer);
  }
  ...
  @protected
  void sse_encode_fs_root(FsRoot self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.id, serializer);
  ...
  @protected
  void sse_encode_list_capability(List<Capability> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
  ...
  @protected
  void sse_encode_list_fs_root(List<FsRoot> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_fs_root(item, serializer);
    }
  }
  ...
  void sse_encode_list_response(ListResponse self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_fs_entry(self.entries, serializer);
  ...
  void sse_encode_register_dto_v_2(RegisterDtoV2 self, SseSerializer serializer) {
    ...
    sse_encode_list_capability(self.capabilities, serializer);
  }
  ...
  @protected
  void sse_encode_roots_response(RootsResponse self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_fs_root(self.roots, serializer);
  }
  ...
  void sse_encode_rs_discovered_device(RsDiscoveredDevice self, SseSerializer serializer) {
    ...
    sse_encode_protocol_type(self.protocol, serializer);
    sse_encode_bool(self.download, serializer);
    sse_encode_Set_capability_None(self.capabilities, serializer);
  }
  ...
  void sse_encode_rs_fs_download_event(RsFsDownloadEvent self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case RsFsDownloadEvent_Started(totalSize: final totalSize, status: final status):
        sse_encode_i_32(0, serializer);
        sse_encode_u_64(totalSize, serializer);
        sse_encode_u_16(status, serializer);
      case RsFsDownloadEvent_Chunk(bytes: final bytes, transferred: final transferred):
        sse_encode_i_32(1, serializer);
        sse_encode_list_prim_u_8_strict(bytes, serializer);
        sse_encode_u_64(transferred, serializer);
      case RsFsDownloadEvent_Finished():
        sse_encode_i_32(2, serializer);
      case RsFsDownloadEvent_Cancelled():
        sse_encode_i_32(3, serializer);
      case RsFsDownloadEvent_Failed(error: final error):
...
class RsHttpClientImpl extends RustOpaque implements RsHttpClient {
  ...
  Stream<RsFsDownloadEvent> fsDownload({
    ...
    BigInt? rangeEnd,
    required RsCancellationToken cancelToken,
  }) => RustLib.instance.api.crateApiHttpRsHttpClientFsDownload(
    that: this,
    protocol: protocol,
    ip: ip,
    port: port,
  ...
  Future<ListResponse> listDir({
    ...
    required int size,
    required String sort,
  }) => RustLib.instance.api.crateApiHttpRsHttpClientListDir(
    that: this,
    protocol: protocol,
    ip: ip,
    port: port,
  ...
  Future<RootsResponse> listRoots({required ProtocolType protocol, required String ip, required int port}) =>
      RustLib.instance.api.crateApiHttpRsHttpClientListRoots(that: this, protocol: protocol, ip: ip, port: port);
